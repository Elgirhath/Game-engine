...
class Rigidbody():
    ...
    def Move(self, vector):
        ...
        self.parent.transform.position = vector3.add(self.parent.transform.position, vector)
    ...
    def Dist_from_ground(self):
        ...
        if ray.Collide(self.parent).point and ray.Collide().point:
            dist_vector = vector3.subtract(ray.Collide().point, ray.Collide(self.parent).point)
        ...
        if obj.rigidbody:
            if obj.rigidbody.use_gravity:
                ...
                if not height or height>0.05:
                    ...
                    obj.rigidbody.velocity = vector3.add(obj.rigidbody.velocity, vector3.scale(g_acc, obj.rigidbody.time_in_air))
